...
date: '2025-07-19'
tags: ['AI']
summary: 'Build an AI image recognition API with MNIST and deploy it to the cloud'
draft: false
---

In the past, I had some experience about AI project, including image recognition and NLP, but all of them were only code.  
...
You can access it by opening the following URL in your browser: http://127.0.0.1:8000/docs
